...
\documentclass[acmconf|,authordraft,screen]{acmart}
...
\caption{ROCs for subclasses of the (a) abnormal MURA superclass and (b) pneumothorax CXR14 superclass. All subclass AUCs are significantly different than the overall task (DeLong p$<$0.05).}
\label{fig:rocs}
\vspace{-6 mm}
\end{figure}
