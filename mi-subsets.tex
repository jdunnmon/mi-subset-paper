...
\hline
 Subclass & \makecell{Baseline \\ Superclass} & \makecell{Baseline \\ Subclass}   &  \makecell{25\% Subsample \\ Superclass}    & \makecell{25\% Subsample \\ Subclass}  &  \makecell{25\% Whiten \\ Superclass}    & \makecell{25\% Whiten \\ Subclass} \\
 \hline
 Dolphin & 0.69 & 0.78  & 0.65  & 0.64 & 0.65  & 0.64   \\
 Mountain & 0.87 & 0.90  & 0.82 & 0.71 & 0.82 & 0.71  \\
 \hline
\end{tabular}
